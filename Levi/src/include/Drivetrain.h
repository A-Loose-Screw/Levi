...
class Drivetrain : public RBC::Subsystems::Subsystem {
 public:
  ...
  void onStop() override {
    RBC_PRINT_ERROR("Stopped Drivetrain");
  }
};

class RobotArm : public RBC::Subsystems::Subsystem {
 public:
  RobotArm() : RBC::Subsystems::Subsystem("<Robot Arm>") {}

  void onUpdate(double dt) override {
    RBC_PRINT_WARN("Hello from robot arm subsystem");
  }
};
